   ...
   <tr align="left" bgcolor="#f2f2f2">
    ...
    <table width="100%" border="1" align="center" cellpadding="0" cellspacing="0">
	  ...
	  ?>
        ...
        <td width="5%" align="center"><a class="one" href="detail_product.php?product_id=<?php echo $row['product_id'];?>">Detail</a></td>
        <td width="5%" align="center"><a class="one" href="delete_product.php?product_id=<?php echo $row['product_id'];?>">Delete</a></td>
       </tr> 
      <?php 
       $color="2";}
	   else{
