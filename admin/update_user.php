...
<form name="edit_user" method="post" action="db_update_user.php" enctype="multipart/form-data">
    <table width="80%" border="0" align="center">
      <tr>
        ...
        <td width="84%"><input type="text" name="first_name" size="50" value="<?php echo  (strtolower($row['first_name'])); ?>" /></td>  
      </tr>
      <tr>
        <td width="16%">Last Name</td>  
        <td width="84%"><input type="text" name="last_name" size="50" value="<?php echo  (strtolower($row['last_name'])); ?>" /></td>  
      </tr>   
	  <tr>
        <td width="16%">Email</td>
        <td><input type="text" name="email" size="50" value="<?php echo $row['email']; ?>" readonly/></td>
      </tr>
      ...
      <tr>
        ...
        <td><textarea name="address" cols="47" rows="3"><?php echo  (strtolower($row['address'])); ?></textarea></td>
      </tr>
      ...
      <tr> 
        ...
        <input type="button" name="cancel" value=" Cancel " onclick="location.href='updateuser.php'" /></td>
      </tr>
