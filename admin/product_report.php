...
<tbody>
    <?php
        $i = 1;
        $query = "SELECT product.product_id, orders_detail.product_id, product.product_name, COUNT(*) AS mycount FROM orders_detail JOIN product ON orders_detail.product_id = product.product_id  GROUP BY product.product_id";
