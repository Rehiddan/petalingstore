...
<form name="edit_user" method="post" action="db_update_admin.php" enctype="multipart/form-data">
    <table width="80%" border="0" align="center">
      <tr>
        ...
        <td width="84%"><input type="text" name="first_name" size="50" value="<?php echo  (strtolower($row['first_name'])); ?>" />
      </tr>
      <tr>
        <td width="16%">Last name</td>  
        <td width="84%"><input type="text" name="last_name" size="50" value="<?php echo  (strtolower($row['last_name'])); ?>" />
      </tr>  
	  <tr>
